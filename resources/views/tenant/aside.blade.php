<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps--active-y" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="/" target="_blank">
        <img src="{{ public_path().'/tenant/img/logo-ct-dark.png' }}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">OptoPharma</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" href="#dashboards" aria-controls="dashboards" role="button" aria-expanded="false" data-bs-toggle="collapse">
            ...
            <ul class="nav nav-sm flex-column">
              <li class="nav-item">
                <a class="nav-link text-white " href="/"0>
                  <i class='fa fa-eye sidenav-mini-icon'></i>
                  <span class="sidenav-normal ms-2 ps-1">Opticals</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white " href="/">
                  <i class="fa fa-stethoscope sidenav-mini-icon"></i>
                  <span class="sidenav-normal ms-2 ps-1">Clinic</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white " href="/">
                  <i class="fa fa-user-md sidenav-mini-icon"></i>
                  <span class="sidenav-normal ms-2 ps-1">Pharmacy</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#opt" aria-controls="opt" role="button" aria-expanded="false" data-bs-toggle="collapse">
            ...
            <span class="nav-link-text ms-1">Opticals</span>
          </a>
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Clinics</h6>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="#clinic" aria-controls="clinic" role="button" aria-expanded="false" data-bs-toggle="collapse">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>Clinics</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <div class="collapse" id="clinic">
            <ul class="nav nav-sm flex-column">
              <li class="nav-item">
                <a class="nav-link text-white " href="/"0>
                  <i class='fa fa-gift sidenav-mini-icon'></i>
                  <span class="sidenav-normal ms-2 ps-1">Patient</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white " href="/">
                  <i class="fa fa-shopping-cart sidenav-mini-icon"></i>
                  <span class="sidenav-normal ms-2 ps-1">Spectacle</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#pharma" aria-controls="pharma" role="button" aria-expanded="false" data-bs-toggle="collapse">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="collapse" id="pharma">
            <ul class="nav nav-sm flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link text-white " href="/">
                  <i class="fa fa-usd sidenav-mini-icon"></i>
                  <span class="sidenav-normal ms-2 ps-1">Purchase Return</span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link text-white " href="/">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Extras</h6>
        </li>       
      </ul>
    </div>
    <div class="sidenav-footer mx-3 ">
      <a class="btn bg-gradient-primary mt-3 w-100" href="/dash/">Upgrade to pro</a>
    </div>
  </aside>